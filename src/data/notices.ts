...
Interested students and parents are requested to fill out the online admission form or visit our front desk between 9:00 AM and 8:00 PM daily.`,
  ...
  {
    id: 'not-02',
    title: 'Schedule for Term Assessment-II and Model Test Series',
...
- Calculators are permitted only in designated Mathematics and Physics papers.
- Punctuality is strictly enforced; students must report 15 minutes prior to the exam start time.
- Parent-teacher evaluation meetings will be held following result tabulation.`,
    isUrgent: true
  },
  {
    id: 'not-03',
    title: 'Mid-Semester Autumn Break & Office Working Hours',
...
- Online homework and practice quizzes will remain accessible on the Student Portal.
- Regular classes will resume promptly on Saturday, October 17, 2026.`,
    isUrgent: false
  },
  {
    id: 'not-04',
    title: 'Official Publication of SSC Pre-Test Performance Results 2026',
...
Students can view their subject-wise marksheet and comparative percentile ranking by logging into their Student Portal. Top rank holders will receive special merit crests during next week's award ceremony.`,
  ...
  {
    id: 'not-05',
    title: 'Installation of Digital Interactive Smartboards in All Rooms',
    date: 'August 28, 2026',
...
Teachers can now illustrate 3D molecular bonds, architectural vector mechanics, and live mathematical graphing seamlessly. We invite parents to visit during open office hours to tour the upgraded learning environment.`,
  ...
  {
    id: 'not-06',
    title: 'Special Extra Care & Doubt-Clearing Workshops Every Friday',
    date: 'August 20, 2026',
    category: 'Important Announcement',
    shortDescription: 'Free supplementary doubt-clearing sessions open for any student wanting extra guidance in Mathematics and Chemistry.',
    content: `To ensure no student is left behind, our senior instructors will host open doubt-clearing clinics every Friday afternoon between 3:00 PM and 6:00 PM.

Students can bring homework problems, tricky textbook theorems, and past exam inquiries for dedicated one-on-one troubleshooting with no additional charges.`,
    isUrgent: false
  }
];
